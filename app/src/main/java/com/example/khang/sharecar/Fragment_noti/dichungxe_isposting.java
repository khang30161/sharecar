...
import com.example.khang.sharecar.SelectItemShareCustomer;
...
public class dichungxe_isposting extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dichungxe_isposting, container, false);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Share").child("post" + "");
        recyclerView = view.findViewById(R.id.rv_dichung);
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                ...
                shareCarAdapter = new ShareCarAdapter(shareManager, getContext(), new ShareCarAdapter.Action() {
                    ...
                    public void onClickItem(ShareManager shareManager, int position) {
                        Intent intent = new Intent(getActivity(), SelectItemShareCustomer.class);
